            ...
            <div class="row">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Просмотр преподавателей</li>
                  </ol>
                </nav>
                <div class="col-lg-8">
                    <!-- Преподаватели -->
                        ...
                        <hr class="text-secondary">
                            ...
                            foreach ($users as $key => $value) {
                                ...
                                echo '<div class="d-flex text-muted pt-3">
                                        <a href="exam_teacher.php?user_id=' . $user_id . '" ><svg class="bd-placeholder-img flex-shrink-0 me-2 rounded" width="32" height="32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 32x32" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#007bff"/><text x="50%" y="50%" fill="#007bff" dy=".3em"></text></svg></a>
                                        <div class="pb-3 mb-0 small lh-sm border-bottom w-100">
                                        <div class="d-flex justify-content-between">
                                            <strong class="text-gray-dark">' . $name . '</strong>
                                            <a href="exam_teacher.php?user_id=' . $user_id . '">Войти</a>
                                        </div>
