...
<html lang="ru">
    ...
    <body class="body-home">
        ...
        <div class="text-center">
            <h1 class="title-article">Изменение информации о курсе</h1>
        </div>
        <div class="container">
        </br><hr></br>
            <?php echo '<form method="POST" action="save_kurs_edit.php?kurs_id=' . $kurs_id . '" enctype="multipart/form-data">'?>
                ...
                <?php echo '<a href="check_teacher.php"class="btn btn-outline-primary me-2">Вернуться</a>'?>
