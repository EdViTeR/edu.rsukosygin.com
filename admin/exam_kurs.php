...
$photo = view_photo($dbo, $_GET['user_id']);
?>
<!doctype html>
<html lang="ru">
    <head>
            ...
            <div class="row">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="exam_teacher.php?user_id=<?php echo $user_id; ?>"><?php echo $head_name; ?></a></li>
                                ...
                                $k++;
                                    echo '<div class="d-flex text-muted pt-3">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <a style="pointer-events: none;" href="edit_theme.php?kurs_id=' . $kurs_id . '&theme_id=' . $theme_id . '">Редактировать</a>
                                                </div>
                                                ...
                                                <div class="card card-body">
                                                    ...
                                                    if (isset($presentation) && !empty($presentation)) {
                                                        echo "<div><a class='btn btn-outline-primary mb-3 me-3' href='" . $presentation . "'>Посмотреть</a>
                                                            <a class='btn btn-outline-danger mb-3 me-3 disabled' href='delete_presentation_kurs.php?theme_id=" . $theme_id . "&kurs_id=" . $kurs_id . "'>Удалить</a></div>";
                                                        unset($presentation);
                                                    } else {
                                                        echo '<form action="upload_presentation.php?kurs_id=' . $kurs_id . '&theme_id=' . $theme_id . '" method="post" enctype="multipart/form-data">
                                                            <input type="file" name="image"><br><br>
                                                            <button disabled="disabled" type="submit" class="btn btn-outline-primary mb-3 me-3">Загрузить</button>
                                                        </form></p>';
                                                    }
                                                echo '</div>
                                                </div>
                ...
                <div class="col-lg-4">
                    <div class="p-5 bg-white border rounded-3">
                        ...
                        <p>Вы авторизировались как <strong>«<?php echo $_GET['user_status'];?>»</strong>.</p> 
