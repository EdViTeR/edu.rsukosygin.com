        ...
        <div class="container">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="check_teacher_info.php">Просмотр преподавателей</a></li>
                            ...
                            if (!$data) {
                                ...
                                foreach ($data as $key => $value) {
                                    ...
                                    echo '<div class="d-flex text-muted pt-3">
                                            <a href="exam_kurs.php?kurs_id=' . $kurs_id . '&user_id=' . $user_id . '&user_status=' . $user_status . '" ><svg class="bd-placeholder-img flex-shrink-0 me-2 rounded" width="32" height="32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 32x32" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#007bff"/><text x="50%" y="50%" fill="#007bff" dy=".3em">32x32</text></svg></a>
                    ...
                    <div class="p-5 bg-white border rounded-3">
                        ...
                        if (!empty($photo) & isset($photo)) {
                            echo '<div class="photo_none">
                                ...
                                <p>Вы авторизировались как <strong>' . $user_status . '</strong>.</p> 
                                <div class="photo_tool">
                                    <p>Изменить фото</p>
                                    <form action="upload.php" method="post" enctype="multipart/form-data">
                                        <input type="file" name="image" disabled="disabled"><br><br>
                                        <button type="submit" class="btn btn-outline-secondary mb-3 me-3 disabled" disabled="disabled">Загрузить</button>
                                    </form>
                                </div>  ';
                        } else {
