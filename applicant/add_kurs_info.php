            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <form method="POST" action="save_order_head.php" enctype="multipart/form-data">
                        <div class="row g-3">
                            <div class="col-12">
                                <label for="kurs_name" class="form-label">Название курса<span class="text-muted"></span></label>
                                <input type="text" class="form-control" id="kurs_name" name="kurs_name" placeholder="Введите название онлайн-курса" required>
                            </div>
                            <div class="col-12">
                                <label for="partic_ok" class="form-label">Дисциплина, которая заменяется онлайн-курсом<span class="text-muted"></span></label>
                                <textarea type="text" name="partic_ok" id="partic_ok" cols="100" class="form-control" rows="3" placeholder="" required></textarea>
                            </div>
                            <div class="col-12">
                                <label for="partic_ok" class="form-label">Направление(я) подготовки специальность(ти)<span class="text-muted"></span></label>
                                <textarea type="text" name="partic_ok" id="partic_ok" cols="100" class="form-control" rows="3" placeholder="Например: 09.03.01 Информатика и вычислительная техника" required></textarea>
                            </div>
                            <br></br><br></br><br></br>
                            <hr>
                            <h5 class="mb-3 ">Описание онлайн-курса (аннотация)</h5><br>
                            <div class="col-12">
                                <label for="partic_ok" class="form-label">Целевая аудитория<span class="text-muted"></span></label>
                                <textarea type="text" name="partic_ok" id="partic_ok" cols="100" class="form-control" rows="3" placeholder="На какую группу пользователей рассчитан данный курс" required></textarea>
                            </div>
                            <div class="col-12">
                                <label for="partic_ok" class="form-label">Необходимый уровень подготовки слушателей<span class="text-muted"></span></label>
                                <textarea type="text" name="partic_ok" id="partic_ok" cols="100" class="form-control" rows="3" placeholder="Опишите необходимый уровень знаний слушателей" required></textarea>
                            </div>
