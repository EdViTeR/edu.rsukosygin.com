<?php
    ...
    $themes_id = $_GET['themes_id'];
    $theme = themes_info($dbo, $themes_id);
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <form method="POST" action="edit_theme.php?themes_id=<?php echo $themes_id;?>&kurs_id=<?php echo $kurs_id;?>" enctype="multipart/form-data">
                        <div class="row g-3">
                            <div class="col-12">
                                <label for="theme_name" class="form-label">Название лекции</label>
                                <input type="text" class="form-control" id="theme_name" name="theme_name" value="<?php echo $name ?>" placeholder="Введите название леции" required>
                            </div>
                            <div class="col-12">
                                <label for="theme_info" class="form-label">Краткое содержание к лекции</label>
                                <textarea type="text" name="theme_info" id="theme_info" cols="100" class="form-control" rows="3" placeholder="Введите краткое содержание лекции" required><?php echo $info ?></textarea>
                            </div>
                        </div>
                        <button class="btn btn-primary btn-lg mt-4 me-3" type="submit">Сохранить</button>
                        <?php
                        	echo '<a href="view_kurs.php?kurs_id=' . $kurs_id . '"class="btn btn-outline-secondary btn-lg mt-4" type="button">Назад</a>';
                ...
                <div class="col-lg-4">
                    <div class="p-5 bg-white border rounded-3">
                        ...
                        <?php echo '<a href="view_kurs.php?kurs_id=' . $kurs_id . '"class="btn btn-outline-primary mb-3 me-3" type="button">Назад</a>';?>
                    </div>
                </div>
            </div>
        </div>
